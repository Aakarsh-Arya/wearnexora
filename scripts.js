...
Thank you!`;
  ...
  // ============================================
  // CHAT FUNCTIONALITY WITH DEEPSEEK VIA OPENROUTER
  // ============================================

  // Chat functionality
  let conversationHistory = [
    { role: 'system', content: 'You are a helpful assistant for NEXORA, a custom apparel company. Help customers with questions about custom T-shirts, hoodies, varsity jackets, pricing, and orders.' }
  ];
    ...
    try {
      const response = await fetch('https://openrouter.ai/api/v1/chat/completions', {
        ...
        headers: {
          ...
          'Authorization': `Bearer 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`,
          'HTTP-Referer': 'https://nexora.in',
          'X-Title': 'NEXORA Chat Assistant'
        },
        body: JSON.stringify({
  ...
  function addMessage(text, sender) {
    ...
    messageDiv.className = `p-2 rounded-lg max-w-xs ${
      sender === 'user'
